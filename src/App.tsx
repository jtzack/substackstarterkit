...
const DEFAULT_CTA_URL = 'https://ship.samcart.com/products/substack-starter-kit'
        ...
        <div className="flex-1 md:max-w-[45%] pb-4">
          ...
          <div className="text-center md:text-left">
            <a href="https://ship.samcart.com/products/substack-starter-kit" className="block md:inline-block bg-black text-white font-serif text-[14px] font-normal uppercase tracking-[0.1em] px-10 py-4 hover:bg-black/85 transition text-center">
              Get the Substack<br className="md:hidden" /> Starter Kit
            </a>
          </div>
  ...
  const questions = [
    {
      ...
      a: "You know you should own your audience. You've read the articles. You've bookmarked the tutorials. You just haven't done it. If you've been \"about to start\" for months, this kit was built for you. You'll have a live Substack set up before you finish Module 1.",
    },
    {
      q: 'Do you have a following on social but <em>no email list?</em>',
      a: "X, LinkedIn, Instagram—you've built an audience on rented land. One algorithm change and it's gone. The kit gives you everything you need to move that audience to email, permanently, before the platform makes that decision for you.",
    },
    {
      q: 'Do you have a <em>Substack</em> that never really took off?',
      a: "You started, posted a few times, and went quiet. The kit is a complete relaunch—better positioning, a real growth strategy, and the systems to stay consistent. Most stalled newsletters don't have a writing problem. They have a positioning problem. Module 1 fixes that.",
    },
    {
      q: 'Do you have a <em>free newsletter</em> but want to go paid?',
      a: "You've built a list but haven't made the jump. You're not sure what to put behind the paywall, how to price it, or how to pitch it. Modules 4 and 6 were built specifically for this moment.",
    },
    {
...
function Sessions() {
  ...
  return (
    <section className="bg-cream py-20 px-6">
      <div className="max-w-page mx-auto">
        <p className="font-sans text-[12px] font-bold text-orange uppercase tracking-[0.15em] mb-3">The 6 Modules</p>
        <h2 className="font-serif text-[clamp(30px,4vw,44px)] leading-[1.15] mb-3">
          Here's what you'll build.
        </h2>
        <p className="font-sans text-[14px] text-black/60 mb-10">
          6 recorded modules · Start anytime · Work at your own pace
        </p>
          ...
          {sessions.map((s) => (
            <div key={s.num} className="py-6 flex flex-col md:flex-row gap-4 md:gap-8">
              <div className="md:w-[160px] flex-shrink-0">
                <img src={`/images/${s.img}`} alt={`Module ${s.num}`} className="w-40 h-40 rounded-lg object-cover" />
              </div>
              <div className="flex-1">
                <span className="font-sans text-[11px] font-bold text-orange uppercase tracking-wider">Module {s.num}</span>
        ...
        <div className="mt-16 text-center">
          <h2 className="font-serif text-[clamp(30px,4vw,48px)] leading-[1.15] mb-6">
            Not information. A build environment.
          </h2>
          <div className="w-40 h-px bg-black/20 mx-auto mb-6" />
          <p className="font-sans text-[15px] font-bold">
            Every module ends with <span className="text-orange">something live</span> on your Substack.
            <br />You finish with <span className="text-orange">a running system</span>, not just notes.
          </p>
        </div>
  ...
  return (
    <section className="bg-dark py-20 px-6">
      <div className="max-w-page mx-auto">
        ...
        <div className="mt-12 text-center">
          <a href="https://ship.samcart.com/products/substack-starter-kit" className="inline-block bg-orange text-white font-sans text-[15px] font-bold uppercase tracking-[0.08em] px-16 py-4 rounded-lg hover:bg-orange/90 transition">
            Get the Substack Starter Kit
          </a>
        </div>
      </div>
  ...
  return (
    <section className="bg-yellow py-20 px-6">
      <div className="max-w-page mx-auto text-center">
        <p className="font-sans text-[12px] font-bold text-orange uppercase tracking-[0.15em] mb-4">Get the Kit</p>
        ...
        <div className="mb-6">
          ...
          <p className="font-serif text-[clamp(48px,8vw,72px)] font-bold leading-none mb-6">$350</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
          ...
          <div className="border-t border-white/10 pt-6">
            ...
            <p className="font-sans text-[14px] text-white/50 leading-relaxed">
              Start the kit, go through the first module,
              and if you decide this isn't what you expected,
...
function FAQ() {
  const faqs = [
    { q: "How much time do I need?", a: "Each module is about 60 minutes. Most people finish the full kit in 1–2 weeks working at their own pace. Every deliverable is built inside the module itself, so there's minimal extra work outside of watching." },
    { q: "Do I need writing experience?", a: "Not at all. The kit starts from zero—how to position your newsletter, how to set it up technically, how to write your first content. No experience required." },
    { q: "I already have a newsletter. Is this still for me?", a: "Yes—especially Modules 2, 4, 5, and 6. If your newsletter isn't growing or converting to paid the way you want, the issue is almost always positioning, offer stack, or monetization architecture." },
    { q: "How is this different from Category Newsletter Creator?", a: "Category Newsletter Creator covers the full business of building a newsletter over time. The Substack Starter Kit is focused specifically on getting your Substack launched, configured, and monetized—start to finish." },
    { q: "How is this different from Ship 30 for 30?", a: "Ship 30 teaches you how to write and publish on social platforms. The kit teaches you how to move that audience to email and monetize it. They're complementary—Ship 30 builds your voice, the kit builds your newsletter business." },
    { q: "Can't I just learn this for free?", a: "You can try—but free content gives you information scattered across hundreds of posts and videos, not a structured build environment. The kit compresses 6+ months of trial and error into a single focused program." },
    { q: "How long do I have access?", a: "Lifetime. All modules, slide decks, templates, .Skills, and bonuses are yours to keep forever." },
  ]
    ...
    <section className="bg-dark-deep py-20 px-6">
      <div className="max-w-page mx-auto">
        ...
        <div className="mt-16 pt-8 border-t border-white/10 text-center">
          <p className="font-sans text-[13px] text-white/30">© 2026 Substack Starter Kit. All rights reserved</p>
        </div>
      </div>
    </section>
  )
